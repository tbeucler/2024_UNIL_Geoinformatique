...
<div style="background-color: #fff3cd; padding: 15px;">
  <b>Notice importante pour poser des questions sur le chat.</b><br />
  Ci-dessous une courte vidéo qui montre comment s'abonner aux canaux dans le chat du cours, et comment envoyer une nouvelle question.

  <video controls="" width="100%">
    <source src="https://files.swisscarto.ch/cartosig/abonnement-canaux.m4v" type="video/mp4">
...
- 2 travaux pratiques qui consistent en l’élaboration de cartes thématiques à l’aide de logiciels informatiques spécialisés . Le premier travail pratique contribue à 30% de la note finale, et le deuxième à 35% de la note finale.
